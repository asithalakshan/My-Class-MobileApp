...
import { GetUserData, UpdateUserData } from '../../../firebase/Student'
        ...
        <SafeAreaView style={styles.scrollContainer}>
            <ScrollView>
                ...
                <View style={{marginHorizontal: 0}}>
                    <ImageBackground source={require('../../../images/student.jpg')} resizeMode='cover' style={styles.image}>
                    ...
                    <View style={styles.mainCard}>
                        <View style={styles.whitecard}>
                            <View style={styles.row}>
                                <View style={{flex: 2}}>
                                  <Iconicons 
                                    ...
                                    size={40} color={Const.grayFontColor} 
                                    style={styles.icons}
                                  />
                                </View>
                                <View style={{flex: 10}}>
                            ...
                            <View style={styles.row}>
                                ...
                                <View style={{flex: 10}}>
                                    <Text style={styles.p1}>School</Text>
                                    <Text style={styles.p}>{userData && userData.school}</Text>
                                </View>
                                <View style={{flex: 2, justifyContent: 'center'}}>
                                    <Iconicons 
                                      name="create-outline" 
                            ...
                            <View style={styles.row}>
                                ...
                                <View style={{flex: 2, justifyContent: 'center'}}>
                                    {/* <Iconicons 
                                      ...
                                      onPress={() => {
                                        setModalVisible(!isModalVisible), 
                                        setModalTitle('NIC Number'), 
                                        setModalData(userData.nic),
                                        setModalType('nic')
                                    }}/> */}
                                </View>
                            </View>
